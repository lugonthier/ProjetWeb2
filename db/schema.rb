...
ActiveRecord::Schema.define(version: 2020_03_03_185059) do
  ...
  create_table "sports", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
    t.integer "frequence"
    t.date "date_begin"
    t.bigint "user_id", null: false
